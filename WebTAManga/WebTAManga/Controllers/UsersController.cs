...
namespace WebTAManga.Controllers
{
    public class UsersController : Controller
    {
        ...
        // POST: Users/Create - Xử lý đăng ký tài khoản
        [HttpPost]
        ...
        public async Task<IActionResult> Create([Bind("Username,Email,Password")] User user)
        {
            ...
            try
            {
                ...
                var emailContent = $@"
                    ...
                    <p>Vui lòng xác nhận email của bạn bằng cách nhấn vào liên kết sau:</p>
                ...
                TempData["Message"] = "Vui lòng kiểm tra email để xác nhận tài khoản!";
